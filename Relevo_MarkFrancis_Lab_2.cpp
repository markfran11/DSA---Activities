...
int main()
{
    ...
    traverse(head);
    cout << insertAfter("Let Me Go by Daniel Caesar", "Pasilyo by Sunkissed Lola", head);
    traverse(head);
    cout << insertAfter ("Always by Rex Orange County","Ikaw Lang by Nobita", head);
    traverse(head);
    cout << insertAfter ("Save Your Tears by The Weekend","Di Na Muli by The Itchyworms", head);
    traverse(head);
