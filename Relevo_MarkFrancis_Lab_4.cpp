...
string dequeue(){
    ...
    rear--;
    return song + " has been deleted the queue";
}

int main(){
    
    cout << enqueue ("Beer - Itchyworms") << endl;
    cout << enqueue ("Ang Huling El Bimbo - Eraserheads") << endl;
    cout << enqueue ("Jopay - Mayonnaise") << endl;
